   ...
   return (
      <Fragment>
         ...
         <button
            ...
            data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" class=" inline-flex items-center p-2 mt-2 ml-3 text-sm w-fit h-fit rounded-lg mm:hidden  focus:outline-none focus:ring-2 text-indigo-800 border-2 border-indigo-800 hover:bg-indigo-700 focus:ring-indigo-600 focus:text-indigo-200">
