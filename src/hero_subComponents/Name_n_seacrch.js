  ...
  return (
    <div className="flex flex-row justify-between sm:flex-col mm:flex-col">
          <div className="flex flex-row w-[10rem] justify-around">
            <p className=' font-bold text-lg'>Hello Sharukh</p>
            <img width="20" height="20" src="https://img.icons8.com/emoji/48/waving-hand-light-skin-tone.png" alt="waving-hand-light-skin-tone" />
          </div>
          <div className="relative sm:mt-2 mm:mt-2">
